...
This is the R package `robfpca` implementing the robust functional principal component analysis (FPCA) for partially observed functional data.
...
The robust covariance function is estimated using the modified Gnanadesikan-Kettenring (GK) identity based on M-estimator, and then orthogonalized.
...
If you use `Simulation/simulation.R`, you can obtain reproducible results in our paper.


## Reference
- Y. Park, H. Kim and Y. Lim (2022+). Functional principal component analysis for partially observed elliptical process, *Submitted*.
