...
The proposed robust FPCA method implements FPCA based on the conditional expectation for the robust covariance function estimate from Orthogonalized Gnanadesikan-Kettenring (OGK) method.
